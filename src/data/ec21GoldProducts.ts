...
export const EC21_GOLD_PRODUCTS: Product[] = [
  // 0. Madebert Minerals Limited (comp-ec21-gold-0)
  {
    id: 'prod-ec21-gold-0-1',
  ...
  // 1. Celia Consulting (comp-ec21-gold-1)
  {
    id: 'prod-ec21-gold-1-1',
    title: 'Physical Gold Bullion Bars 999.9 Fine (1kg LBMA Hallmarked)',
    category: 'Minerals & Metallurgy',
    subCategory: 'Precious Metals & Bullion',
    supplierId: 'comp-ec21-gold-1',
  ...
  // 2. Brown's Global Exchange (comp-ec21-gold-2)
  {
    id: 'prod-ec21-gold-2-1',
    title: 'High-Purity Iridium Powder & Sintered Iridium Crucibles (99.95%)',
    category: 'Minerals & Metallurgy',
    subCategory: 'Precious Metals & Bullion',
    supplierId: 'comp-ec21-gold-2',
  ...
  // 3. Mustache Gold and Silver (comp-ec21-gold-3)
  {
    id: 'prod-ec21-gold-3-1',
    title: 'Wholesale Karat Gold Scrap Parcels (10k, 14k, 18k, 22k Melt)',
    category: 'Minerals & Metallurgy',
    subCategory: 'Precious Metals & Bullion',
    supplierId: 'comp-ec21-gold-3',
  ...
  // 5. Kax Group Llc (comp-ec21-gold-5)
  {
    id: 'prod-ec21-gold-5-1',
    title: 'Natural Uncut Rough Diamond Parcels (Kimberley Certified 2ct-10ct)',
    category: 'Minerals & Metallurgy',
    subCategory: 'Precious Metals & Bullion',
    supplierId: 'comp-ec21-gold-5',
  ...
  // 6. Gsk Global Traders (comp-ec21-gold-6)
  {
    id: 'prod-ec21-gold-6-1',
    title: 'Standard Gold Dore Bars 22K (96.5% Min Au) - Direct Offtake',
    category: 'Minerals & Metallurgy',
    subCategory: 'Precious Metals & Bullion',
    supplierId: 'comp-ec21-gold-6',
  ...
  // 7. Peddy Pedro Enterprise (comp-ec21-gold-7)
  {
    id: 'prod-ec21-gold-7-1',
  ...
  // 9. Lead Technologies (comp-ec21-gold-9)
  {
    id: 'prod-ec21-gold-9-1',
  ...
  // 11. JL Enterprises (comp-ec21-gold-11)
  {
    id: 'prod-ec21-gold-11-1',
    title: 'LBMA Certified Good Delivery Gold Bars (400 oz / 12.5 kg)',
    category: 'Minerals & Metallurgy',
    subCategory: 'Precious Metals & Bullion',
    supplierId: 'comp-ec21-gold-11',
  ...
  // 12. Gannon & Scott Inc (comp-ec21-gold-12)
  {
    id: 'prod-ec21-gold-12-1',
    title: 'Secondary Refined Fine Gold Grain & Casting Shot (.9999 Fine)',
    category: 'Minerals & Metallurgy',
    subCategory: 'Precious Metals & Bullion',
    supplierId: 'comp-ec21-gold-12',
  ...
  // 13. Minetech Co., Limited (comp-ec21-gold-13)
  {
    id: 'prod-ec21-gold-13-1',
  ...
  // 14. Gig for International Trading and Consulting (comp-ec21-gold-14)
  {
    id: 'prod-ec21-gold-14-1',
    title: 'Investment Cast Gold Bars 24K (100g / 500g / 1kg Assayed)',
    category: 'Minerals & Metallurgy',
    subCategory: 'Precious Metals & Bullion',
    supplierId: 'comp-ec21-gold-14',
  ...
  // 16. Henan Mingyuan Heavy Industrial Equipment Co., LTD (comp-ec21-gold-16)
  {
    id: 'prod-ec21-gold-16-1',
    title: 'High-Capacity Primary Jaw Crusher & Ball Mill for Gold Ore Beneficiation',
    category: 'Industrial Machinery & Tools',
    subCategory: 'Mining & Mineral Processing Machinery',
    supplierId: 'comp-ec21-gold-16',
  ...
  // 17. Golden State Mint (comp-ec21-gold-17)
  {
    id: 'prod-ec21-gold-17-1',
    title: '1 oz .9999 Pure Fine Gold Bullion Rounds & Minted Bars (ISO 9001)',
    category: 'Minerals & Metallurgy',
    subCategory: 'Precious Metals & Bullion',
    supplierId: 'comp-ec21-gold-17',

...
export const INITIAL_SAAS_PLANS: SaaSPlan[] = [
  // 1. SUPPLIER & EXPORTER MEMBERSHIP PLANS
  {
    ...
    featuresList: [
      '**Verified & Genuine Orders:**',
      'Verified & Genuine Order Matching (Up to 20/mo)',
      '**Catalog & Listings:**',
      'Dedicated Catalogue Page (Up to 50 Product Listings)',
      '10 Ready to Ship Listings',
      'Priority Listings (Standard Tier)',
      '2 Product Banners / Showcase Slots',
      '**Website, Domain & Security:**',
      'Business Website (1-Page Dedicated Business Microsite)',
      'Domain and Hosting Services Included',
      'SSL (Secure Socket Layer) Certificate',
      'Live Chat on the Website (WhatsApp & Direct Web Chat)',
      'Language Converter (Multi-language Translation Widget)',
      '**Trade Intelligence & Support:**',
      'Trade Analyst Data & Basic Market Insights',
      'Global Trade Events Directory Access',
      'Dedicated Account Manager / Export CSR',
  ...
  },
  {
    ...
    featuresList: [
      '**Verified & Genuine Orders:**',
      '40 Verified & Genuine Orders / Month + Advance Terms',
      '**Catalog & Listings:**',
      'Dedicated Catalogue Page (Up to 100 Products & 20 Digital Catalog)',
      '50 Ready to Ship Listings',
      'Priority Listings (Enhanced Ranking)',
      '2 Professional Product Banners',
      '**Website, Domain & Security:**',
      'Business Website (Dynamic SEO E-commerce Website)',
      'Domain and Hosting Services Fully Managed',
      'SSL (Secure Socket Layer) Enterprise Encryption',
      'Live Chat on the Website (AI Chat Bot Integration)',
      'Language Converter (Automated Real-Time Language Converter)',
      '**Trade Intelligence & Support:**',
      'Trade Analyst Data & International Trade Shows Update',
      'Global Trade Events VIP Pass & Invites',
      'International Export Manager (IEM) & Account Manager',
  ...
  },
  {
    ...
    featuresList: [
      '**Verified & Genuine Orders:**',
      '60+ Verified & Genuine Orders / Month + Priority Escrow Protection',
      '**Catalog & Listings:**',
      'Dedicated Catalogue Page (200+ Products & Custom Flipbook)',
      '100 Ready to Ship Listings',
      'Top Priority Marketplace Listings & Spotlight',
      '4 Premium Product Banners & Spotlight Ads',
      '**Website, Domain & Security:**',
      'Business Website (Dynamic / E-commerce Corporate Website)',
      'Custom Domain and Hosting Services (High Speed CDN)',
      'Advanced SSL (Secure Socket Layer) & DDoS Protection',
      'Live Chat on the Website (24/7 AI & Human Live Chat)',
      'Language Converter (Multi-Language AI Translator)',
      '**Trade Intelligence & Support:**',
      'Trade Analyst Data & Comprehensive Customs Reports',
      'Global Trade Events VIP Delegation Access',
      'Senior International Export Manager & Dedicated Account Manager',
      '24/7 VIP Working Support'
    ],
  ...
  // 2. BUYER & IMPORTER MEMBERSHIP PLANS
  {
    ...
    featuresList: [
      '**Verified & Genuine Orders:**',
      'Verified & Genuine Order Tracking & Trade Assurance',
      '**Catalog & Listings:**',
      'Dedicated Catalogue Page Access for Global Sourcing',
      'Unlimited Ready to Ship Inventories Access',
      'Priority RFQ Broadcast Listings',
      'Featured Sourcing Banners',
      '**Website, Domain & Security:**',
      'Business Website Sourcing Portal Access',
      'Secure Cloud Domain and Hosting Services',
      'SSL (Secure Socket Layer) Encrypted Vault',
      'Live Chat on the Website (Supplier Live Chat)',
      'Language Converter (Instant Supplier Language Translator)',
      '**Trade Intelligence & Support:**',
      'Trade Analyst Data & Factory Audit Intelligence',
      'Global Trade Events Buyer Delegation Pass',

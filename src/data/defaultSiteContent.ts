...
export const DEFAULT_SITE_CONTENT: SiteContent = {
  ...
  premiumPlansPage: {
    ...
    tiers: [
      {
        id: "FREE",
        name: "Free Starter Exporter",
        badgeColor: "bg-slate-100 text-slate-700 border-slate-300",
        description: "Essential baseline features for micro-exporters and startup trading houses.",
        annualUsd: 0,
        monthlyUsd: 0,
        dailyQuotes: "3 Quotes/day",
        catalogListings: "10 Products",
        escrowFee: "3.5%",
        features: [
          "Standard Company Profile in Directory",
          "3 Daily Quotes to Public RFQs",
          "Standard Email Notification on Leads",
          "Up to 10 Live Product Catalog Listings",
          "Escrow Protection at Standard 3.5% Fee",
          "Basic Message Center Access"
        ],
        popular: false,
        cta: "Current Plan"
      },
      {
        id: "GOLD",
        name: "Gold Verified Supplier",
        badgeColor: "bg-amber-100 text-amber-900 border-amber-300",
        description: "The premier benchmark for established manufacturers seeking consistent global contract orders.",
        annualUsd: 2899,
        monthlyUsd: 299,
        dailyQuotes: "30 Quotes/day",
        catalogListings: "250 Products",
        escrowFee: "1.8%",
        features: [
          "Gold Verified Supplier Badge & Certificate",
          "30 High-Priority Daily Quotes to Verified RFQs",
          "Instant SMS & WhatsApp Buy Lead Dispatch",
          "250 High-Res Product & Video Listings",
          "Top 3 Search Category Ranking Boost",
          "Reduced 1.8% Trade Assurance Escrow Fee",
          "Dedicated Key Account Manager (Bilingual)",
          "Custom Online B2B 3D Showroom"
        ],
        popular: true,
        cta: "Upgrade to Gold"
      },
      {
        id: "VIP",
        name: "VIP Enterprise Exporter",
        badgeColor: "bg-indigo-100 text-indigo-900 border-indigo-300",
        description: "Full-spectrum global trade suite for enterprise conglomerates and OEM/ODM gigafactories.",
        annualUsd: 5999,
        monthlyUsd: 599,
        dailyQuotes: "Unlimited",
        catalogListings: "Unlimited",
        escrowFee: "0.9%",
        features: [
          "VIP Global Sovereign Tier Badge",
          "Unlimited Direct Instant Quotes to All RFQs",
          "First-Look Private RFQ Access (48h Headstart)",
          "Unlimited Product & Video Catalog",
          "Permanent Sponsored Category Header Spot",
          "Lowest 0.9% Escrow Fee + L/C Settlement",
          "On-site Video Factory Audit by TÜV / SGS",
          "Direct Matchmaking with Fortune 500 Buyers",
          "Custom API Access & ERP Inventory Sync"
        ],
        popular: false,
        cta: "Upgrade to VIP Enterprise"
      }
    ],
    creditPacks: [
      {
        id: "credits-25",
        name: "25 RFQ Quote Credits",
        credits: 25,
        priceUsd: 149,
        costPerQuote: "$5.96 / lead",
        popular: false,
        description: "Ideal for testing high-value niche buy leads."
      },
      {
        id: "credits-100",
        name: "100 RFQ Quote Credits",
        credits: 100,
        priceUsd: 499,
        costPerQuote: "$4.99 / lead",
        popular: true,
        description: "Most popular for seasonal export campaigns & tenders."
      },
      {
        id: "credits-300",
        name: "300 RFQ Quote Credits",
        credits: 300,
        priceUsd: 1199,
        costPerQuote: "$3.99 / lead",
        popular: false,
        description: "High volume pack with priority lead routing."
      }
    ],
    faqs: [
      {

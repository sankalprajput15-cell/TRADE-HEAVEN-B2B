          ...
          <div className="absolute bottom-5 left-5 right-5 flex flex-col md:flex-row md:items-end justify-between gap-4">
              ...
              <div className="text-white space-y-1">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className="text-[11px] text-slate-300 font-medium hidden sm:inline">
                    Member for {profile.yearsInBusiness || (new Date().getFullYear() - profile.establishedYear)} Years
                  </span>
                </div>
                ...
                <div className="flex items-center gap-3 text-xs text-slate-200 flex-wrap font-medium">
                  ...
                  <div className="flex items-center gap-1 text-emerald-300 font-bold">
                    ...
                    <span>{profile.responseRate} Response Rate ({profile.avgResponseTime})</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-900/80 backdrop-blur-md p-3.5 rounded-2xl border border-white/20 text-right shrink-0 shadow-xl hidden lg:block">
              ...
              <div className="text-[10px] text-slate-400">
                {profile.completedOrdersCount} Global Shipments Completed
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="px-6 py-4 bg-slate-50 border-t border-slate-200 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span>Send Inquiry / RFQ</span>
            </button>

            {onOpenCreateRfq && (
              <button
                onClick={onOpenCreateRfq}
                className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-white hover:bg-slate-100 text-slate-800 font-bold text-xs border border-slate-300 shadow-xs transition-all cursor-pointer"
              >
            ...
            >
              ...
              <span>{isBookmarked ? 'Following' : 'Bookmark Supplier'} ({followersCount})</span>
            </button>
          </div>
          ...
          <div className="flex items-center gap-4 text-xs font-medium text-slate-600">
            <div className="flex items-center gap-1">
              ...
              <span>Verified On-Site Audit</span>
            </div>
            <div className="flex items-center gap-1">
              <Factory className="w-4 h-4 text-blue-600" />
              <span>{profile.factorySizeSqM.toLocaleString()} m² Facility</span>
            </div>
          </div>
        </div>
      </div>

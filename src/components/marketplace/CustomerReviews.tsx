...
const reviewsDataset = [
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&q=80"
  },
  {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="flex flex-wrap items-center gap-x-8 gap-y-4 px-6 pt-5 border-b border-gray-200 text-sm font-semibold overflow-x-auto">
          <button className="pb-3 border-b-2 border-gray-900 text-gray-900 flex items-center gap-1.5 focus:outline-none whitespace-nowrap">
            All Reviews <span className="text-gray-500 font-normal">4.8</span>
          </button>

          <button className="pb-3 border-b-2 border-transparent text-gray-500 hover:text-gray-800 flex items-center gap-1.5 focus:outline-none transition-colors whitespace-nowrap">
            {/* Google 'G' Logo SVG */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 p-5 sm:p-6 bg-gray-50/30 max-h-[800px] overflow-y-auto">
